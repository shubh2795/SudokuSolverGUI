...
public class GameGenerator {
    ...
    private static int[][] unsolvedGame(int[][] solvedGame) {
        ...
        while ( solvable = false ) {
            SudokuUtilities.copySudokuArrayVaues(solvedGame, solvableArray);
            int index = 0;
            while ( index < 40 ) {
            ...
            SudokuUtilities.copySudokuArrayVaues(solvableArray, toBeSolved);
            solvable = SudokuSolver.puzzleIsSolvabe(toBeSolved);
        }
