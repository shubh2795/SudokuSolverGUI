...
public class SudokuBoardDisplay  extends JComponent {
    ...
    private static  int CELL_PIXELS = 65;
    private static  int PUZZLE_SIZE = 9;
    private static  int SUBSQUARE   = 3;
    private static  int BOARD_PIXELS = CELL_PIXELS * PUZZLE_SIZE;
    private static  int TEXT_OFFSET = 15;
    private static  Font TEXT_FONT  = new Font("Calibri", Font.BOLD, 24);
